import type { MailT, RawMailT } from '../mailList/types';
...
export const YURI_MAIL_M25752: MailT = {
  ...rawYuri,
  ...rawYuriBody,
...
export const HITOMI_MAIL: MailT = {
  id: 'm25708',
  member: '혼다 히토미',
  subject: 'Last ',
  preview: 'こんばんは！ ひいです🍓 2年6ヶ月の間いつも応援してくれてたくさん愛してくれてどんなときも側にいてくれて本当にありがとうございました。 そしてこの “ひいめーる” を通じて{_nickname_}と',
  body: 'こんばんは！ ひいです🍓 2年6ヶ月の間いつも応援してくれてたくさん愛してくれてどんなときも側にいてくれて本当にありがとうございました。 そしてこの “ひいめーる” を通じて{_nickname_}と',
  bodyText: 'こんばんは！ ひいです🍓 2年6ヶ月の間いつも応援してくれてたくさん愛してくれてどんなときも側にいてくれて本当にありがとうございました。 そしてこの “ひいめーる” を通じて{_nickname_}と',
  images: [],
