	...
	return (
		<VStack className="p-2 h-screen w-full bg-purple-200 gap-1">
			...
			<Chat
				...
				first={true}
			/>
			<Chat name="장원영" image="장원영" message="기다려서 내가 더 보고 시펐징?" time={new Date()} />
			<Chat name="장원영" image="장원영" message="보고싶었는데 연락해서 좋았어" time={new Date()} />
			<Chat name="장원영" image="장원영" message="안녕" time={new Date()} last={true} />
			<Chat name="위즈원" image="" message="오늘도 화이팅" time={new Date()} position="end" first={true} last={true} />
		</VStack>
	);
}
